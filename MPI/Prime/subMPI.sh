...
srun --partition=cola-corta --time=00:15:00 -N 4 -n 16 ./prime_v0
...
srun --partition=cola-corta --time=00:15:00 -N 4 -n 16 ./prime_v1
...
srun --partition=cola-corta --time=00:15:00 -N 4 -n 16 ./prime_v2
