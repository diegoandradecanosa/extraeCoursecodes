...
day=`date '+%d'`
srun --time=00:15:00 --partition=thinnodes  --reservation=PROFILING_${day}Nov -p shared --qos=shared 4 -n 16 ./poisson_v0 
...
day=`date '+%d'`
srun --time=00:15:00 --partition=thinnodes  --reservation=PROFILING_${day}Nov -p shared --qos=shared -N 4 -n 16 ./poisson_v1
